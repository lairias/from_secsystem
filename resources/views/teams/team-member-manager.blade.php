<div>
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-form-section submit="addTeamMember">
                ...
                <x-slot name="description">
                    {{ __('Agregue un nuevo miembro del equipo a su equipo, lo que le permitirá colaborar con usted.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Proporcione la dirección de correo electrónico de la persona que le gustaría agregar a este equipo.') }}
                        </div>
                    </div>
    ...
    <x-jet-confirmation-modal wire:model="confirmingLeavingTeam">
        ...
        <x-slot name="content">
            {{ __('¿Estás seguro de que te gustaría dejar este equipo?') }}
        </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingTeamMemberRemoval">
        ...
        <x-slot name="content">
            {{ __('¿Está seguro de que desea eliminar a esta persona del equipo?') }}
        </x-slot>
